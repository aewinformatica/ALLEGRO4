...
;カンフー突き手（弱）
[State -1, water missile]
type = ChangeState
value = 1200
triggerall = command = "Water Dragon"
trigger1 = power >= 1500
trigger1 = statetype = S
...
type = changestate
value = 9000
triggerall = command = "holdx" && command = "holda"
trigger1 = alive&&ctrl&&statetype!=A

;---------------------------------------------------------------------------
;Windmill Shuriken Throw
[state -1, W shuriken]
type = changestate
value = 510
triggerall = command = "windmill shuriken" 
trigger1 = alive&&ctrl&&statetype!=A
...
type = ChangeState
value = 1100
triggerall = command = "Karyuu Endan"
trigger1 = power >= 1000
trigger1 = statetype = S

;---------------------------------------------------------------------------
;Karyuu Endan continue
[State -1, continue move]
type = ChangeState
value = 1102
