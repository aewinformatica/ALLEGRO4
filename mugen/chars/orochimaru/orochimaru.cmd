...
;   buffer.time = time (optional...Linux/WinM.U.G.E.N only)
;
; - some_name
...
;   if omitted
;
; - buffer.time (optional...Linux/WinM.U.G.E.N only)
...
[Command]
name = "Sharingan"   ;Same name as above
command = ~D, B, b
time = 25
...
triggerall = Statetype != A
triggerall = p2life != 0
triggerall = (stateno = 200) && (time >= 12)
triggerall = p2movetype = H
trigger1 = statetype = S
