...
[State -1, Sharingan]
type = changestate
triggerall = command = "a" && numhelper(6000) = 0 && var(0) = 0
triggerall = command ="holddown"
...
triggerall = Statetype != A
triggerall = p2life != 0
triggerall = (stateno = 250) && (time >= 10)
triggerall = p2movetype = H
trigger1 = statetype = S
