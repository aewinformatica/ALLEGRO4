...
int main()
{
   ...
   { 
        ...
        //menuprincipal(); usado na funcao acima
...
int telainicial()
{
      ...
      //show_mouse(fundoy);//coloca mouse no bitmap fundo
...
{  
      MIDI	*musica; 
      SAMPLE *musica2,*nave;
      BITMAP *buffer,*fundo,*x,*aux,*rocha1,*rocha2,*cursor;
      DATAFILE *datFontes = NULL;
      datFontes = load_datafile("fonthistoria.dat");
     ...
     // play_sample(musica2,255,90,1000,0);
      ...
      cursor = load_png("fundos/cursor.png",NULL);
