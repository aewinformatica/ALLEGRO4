...
/*Retorna próximo token e incrementar a posição interna
  do token atual
 */
...
/* Deleta tokens que sao comentadas
  com o  token '!' como primeiro caracter do nome, e.g:
