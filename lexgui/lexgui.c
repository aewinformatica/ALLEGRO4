...
int lex_label_proc(int msg, DIALOG *d, int c) {
    textout_ex(screen, font, "Nome:", d->x + lex_skin.dialog.bg.grid[0]->w, d->y + (lex_skin.dialog.bg.grid[1]->h - text_height(font))/2, lex_skin.dialog.textcolor[0],-1);
