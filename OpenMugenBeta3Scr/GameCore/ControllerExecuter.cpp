...
void CControllerExecuter::SetPlayer(void *temp)
{
    lpPlayer=temp;
}
...
void CControllerExecuter::ChangeAnim()
{
    ...
    nAnimToChange=(int)((CPlayer*)lpPlayer)->GetParamValue(PA_VALUE);
    ((CPlayer*)lpPlayer)->ChangeAnim(nAnimToChange);
...
void CControllerExecuter::VelSet()
{
    ...
    x=((CPlayer*)lpPlayer)->GetParamValue(PA_XVALUE);
    y=((CPlayer*)lpPlayer)->GetParamValue(PA_YVALUE);
#ifdef DEBUG
