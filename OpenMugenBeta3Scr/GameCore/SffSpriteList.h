...
class CSffSpriteList 
{


private:
	SffSpriteLinkedList *Anfang;
	SffSpriteLinkedList *Ende;
	SffSpriteLinkedList *Aktuell;

public:
	CSffSpriteList();
	~CSffSpriteList();
	void Hinzufuegen(SffSpriteLinkedList *SffSpriteData);
	void Next();
	void Prev();
	SffSpriteLinkedList * GetSffSprite(int nImageNumber,int nGroupNumber);
	SffSpriteLinkedList * GetData(){return Aktuell;};
