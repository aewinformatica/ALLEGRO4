...
//Contructor & Destructor
    CFightEngine();
    ~CFightEngine();
void InitFightEngine(CVideoSystem *p);

void LoadPlayer1(char *strPlayer);    
void LoadPlayer2(char *strPlayer);
void ResetRound();
void RunEngine();
...
CPlayer* lpPlayer1;
CPlayer* lpPlayer2;
/* TODO (Sahin#1#): Must be implement Player3 and player4 but later time */
CVideoSystem *pVideo;
