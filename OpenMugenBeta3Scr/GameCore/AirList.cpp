...
void CAirList::Hinzufuegen(AirLinkedList *AirData)
{
	if(Anfang==NULL)
	{
		Anfang=Ende=Aktuell=AirData;
		AirData->NachFolger=NULL;
		AirData->VorGaenger=NULL;

	}
	else
	{
		Ende->NachFolger=AirData;
		AirData->VorGaenger=Ende;
		AirData->NachFolger=NULL;
		Ende=AirData;
