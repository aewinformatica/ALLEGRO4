/*
Biblioteca de Desenvolvimento de Jogos do Curso de Engenharia da Computa��o da UNISINOS
by Farlei J. Heinen (30/05/2006) - farleih@gmail.com

Fun��es de Colis�o obtidas de: Ivan Baldo - lubaldo@adinet.com.uy (PPCol Library)

10/05/2007
Vers�o atualizada para suporte ao Dev-Cpp com Allegro 4.2
...
void read_string(char *str_to, int size, int x, int y)
{
	...
	while (the_key>>8 != KEY_ENTER)
	{
		...
		//clear(tela);
		//textout(tela,font, str_to, x,y, makecol(255,255,255));
		clear(screen);
